...
module AsposeThreeDCloud
  ...
  class ObjSaveOption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Verbose')
        self.verbose = attributes[:'Verbose']
      end

      if attributes.has_key?(:'SerializeW')
        self.serialize_w = attributes[:'SerializeW']
      end

      if attributes.has_key?(:'EnableMaterials')
        self.enable_materials = attributes[:'EnableMaterials']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          verbose == o.verbose &&
          serialize_w == o.serialize_w &&
          enable_materials == o.enable_materials &&
    ...
    def hash
      [save_format, file_system, lookup_paths, file_name, file_format, directory, verbose, serialize_w, enable_materials, flip_coordinate_system].hash
    end
