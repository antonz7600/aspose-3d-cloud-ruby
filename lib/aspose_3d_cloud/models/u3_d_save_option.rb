...
module AsposeThreeDCloud
  ...
  class U3DSaveOption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'MeshCompression')
        self.mesh_compression = attributes[:'MeshCompression']
      end

      if attributes.has_key?(:'ExportNormals')
        self.export_normals = attributes[:'ExportNormals']
      end

      if attributes.has_key?(:'ExportTextureCoordinates')
        self.export_texture_coordinates = attributes[:'ExportTextureCoordinates']
      end

      if attributes.has_key?(:'ExportVertexDiffuse')
        self.export_vertex_diffuse = attributes[:'ExportVertexDiffuse']
      end

      if attributes.has_key?(:'ExportVertexSpecular')
        self.export_vertex_specular = attributes[:'ExportVertexSpecular']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mesh_compression == o.mesh_compression &&
          export_normals == o.export_normals &&
          export_texture_coordinates == o.export_texture_coordinates &&
          export_vertex_diffuse == o.export_vertex_diffuse &&
          export_vertex_specular == o.export_vertex_specular
    end
    ...
    def hash
      [save_format, file_system, lookup_paths, file_name, file_format, directory, flip_coordinate_system, mesh_compression, export_normals, export_texture_coordinates, export_vertex_diffuse, export_vertex_specular].hash
    end
