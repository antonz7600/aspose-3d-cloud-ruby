...
module AsposeThreeDCloud
  ...
  class U3DSaveOption
    ...
    def hash
      [save_format, lookup_paths, file_name, file_format, flip_coordinate_system, mesh_compression, export_normals, export_texture_coordinates, export_vertex_diffuse, export_vertex_specular].hash
    end
