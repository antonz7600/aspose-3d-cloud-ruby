...
module AsposeThreeDCloud
  ...
  class Entity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Cylinder')
        self.cylinder = attributes[:'Cylinder']
      end

      if attributes.has_key?(:'Sphere')
        self.sphere = attributes[:'Sphere']
      end

      if attributes.has_key?(:'Torus')
        self.torus = attributes[:'Torus']
      end
    ...
    def hash
      [type, box, cylinder, sphere, torus, plane].hash
    end
