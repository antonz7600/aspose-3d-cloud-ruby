...
module AsposeThreeDCloud
  ...
  class FBXSaveOption
    ...
    def hash
      [save_format, lookup_paths, file_name, file_format, enable_compression, fold_repeated_curve_data, export_legacy_material_properties, video_for_texture, generate_vertex_element_material].hash
    end
