...
module AsposeThreeDCloud
  ...
  class Vector3
    ...
    def list_invalid_properties
      ...
      if @length2.nil?
        invalid_properties.push("invalid value for 'length2', length2 cannot be nil.")
      end
