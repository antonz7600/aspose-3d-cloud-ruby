...
module AsposeThreeDCloud
  ...
  class Transform
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PreRotation')
        self.pre_rotation = attributes[:'PreRotation']
      end

      if attributes.has_key?(:'PostRotation')
        self.post_rotation = attributes[:'PostRotation']
      end

      if attributes.has_key?(:'EulerAngles')
        self.euler_angles = attributes[:'EulerAngles']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scale == o.scale &&
          pre_rotation == o.pre_rotation &&
          post_rotation == o.post_rotation &&
          euler_angles == o.euler_angles
    end
    ...
    def hash
      [translation, scale, pre_rotation, post_rotation, euler_angles].hash
    end
