...
module AsposeThreeDCloud
  ...
  class RvmSaveOption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'FileNote')
        self.file_note = attributes[:'FileNote']
      end
    ...
    def hash
      [save_format, file_system, lookup_paths, file_name, file_format, directory, file_note, author, creation_time, file_content_type].hash
    end
