...
module AsposeThreeDCloud
  ...
  class Box
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'LengthSegments')
        self.length_segments = attributes[:'LengthSegments']
      end
    ...
    def list_invalid_properties
      ...
      if @length_segments.nil?
        invalid_properties.push("invalid value for 'length_segments', length_segments cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @length_segments.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          height == o.height &&
          name == o.name &&
          length_segments == o.length_segments &&
    ...
    def hash
      [length, width, height, name, length_segments, width_segments, height_segments].hash
    end
