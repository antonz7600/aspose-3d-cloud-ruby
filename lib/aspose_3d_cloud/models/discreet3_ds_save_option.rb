...
module AsposeThreeDCloud
  ...
  class Discreet3DSSaveOption
    ...
    def hash
      [save_format, lookup_paths, file_name, file_format, export_light, export_camera, duplicated_name_separator, duplicated_name_counter_base, duplicated_name_counter_format, master_scale, gamma_corrected_color, flip_coordinate_system, high_precise_color].hash
    end
