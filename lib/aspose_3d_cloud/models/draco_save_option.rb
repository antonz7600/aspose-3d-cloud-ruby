...
module AsposeThreeDCloud
  ...
  class DracoSaveOption
    ...
    def hash
      [save_format, file_system, lookup_paths, file_name, file_format, directory, position_bits, texture_coordinate_bits, color_bits, normal_bits, compression_level].hash
    end
