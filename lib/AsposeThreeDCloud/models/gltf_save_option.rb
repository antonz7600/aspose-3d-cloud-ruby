...
module AsposeThreeDCloud
  ...
  class GLTFSaveOption
    ...
    def hash
      [save_format, file_system, lookup_paths, file_name, file_format, directory, pretty_print, embed_assets, use_common_materials, flip_tex_coord_v, buffer_file, save_extras, draco_compression, file_content_type].hash
    end
