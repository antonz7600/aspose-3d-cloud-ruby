...
module AsposeThreeDCloud
  ...
  class Torus
    ...
    attr_accessor :tubular_segments
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TubularSegments')
        self.tubular_segments = attributes[:'TubularSegments']
      end

      if attributes.has_key?(:'Arc')
        self.arc = attributes[:'Arc']
      end
    ...
    def list_invalid_properties
      ...
      if @tubular_segments.nil?
        invalid_properties.push("invalid value for 'tubular_segments', tubular_segments cannot be nil.")
      end

      if @arc.nil?
        invalid_properties.push("invalid value for 'arc', arc cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @tubular_segments.nil?
      return false if @arc.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          tubular_segments == o.tubular_segments &&
          arc == o.arc
    end
    ...
    def hash
      [name, radius, tube, radial_segments, tubular_segments, arc].hash
    end
