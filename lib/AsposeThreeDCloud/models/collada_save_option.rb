...
module AsposeThreeDCloud
  ...
  class ColladaSaveOption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Indented')
        self.indented = attributes[:'Indented']
      end

      if attributes.has_key?(:'TransformStyle')
        self.transform_style = attributes[:'TransformStyle']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          indented == o.indented &&
          transform_style == o.transform_style
    end
    ...
    def hash
      [save_format, file_system, lookup_paths, file_name, file_format, directory, indented, transform_style].hash
    end
