...
module AsposeThreeDCloud
  ...
  class PdfSaveOption
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RenderMode')
        self.render_mode = attributes[:'RenderMode']
      end

      if attributes.has_key?(:'LightingScheme')
        self.lighting_scheme = attributes[:'LightingScheme']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          lighting_scheme == o.lighting_scheme
    end
    ...
    def hash
      [save_format, file_system, lookup_paths, file_name, file_format, directory, flip_coordinate_system, render_mode, lighting_scheme].hash
    end
