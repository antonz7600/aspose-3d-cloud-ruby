...
# Unit tests for AsposeThreeDCloud::AccessTokenResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccessTokenResponse' do
  before do
    # run before each test
    @instance = AsposeThreeDCloud::AccessTokenResponse.new
  end
  ...
  describe 'test an instance of AccessTokenResponse' do
    it 'should create an instance of AccessTokenResponse' do
      expect(@instance).to be_instance_of(AsposeThreeDCloud::AccessTokenResponse)
    end
  end
